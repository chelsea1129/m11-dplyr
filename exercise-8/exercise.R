...
most.prizes.publication <- filter(pulitzer, Pulitzer.Prize.Winners.and.Finalists..2004.2014 == 
                                    max(Pulitzer.Prize.Winners.and.Finalists..2004.2014)) %>%
                            select(Newspaper)
most.prizes.publication
...
publication <- filter(pulitzer, Pulitzer.Prize.Winners.and.Finalists..2004.2014 >= 5) %>%
